...
class SoftDrinkPage extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    return Scaffold(
      appBar: AppBar(
        title: Text('Sushi Menu', style: TextStyle(color: Colors.white)),
          ...
          child: Column(
            ...
            children: [
              ...
              SushiItem(
                ...
                rating: 4.7,
                reviews: 200,
                description: 'Slices of fresh tuna served with soy sauce and wasabi.',
              ),
              SushiItem(
              ...
              SushiItem(
                ...
                rating: 4.6,
                reviews: 180,
                description: 'Grilled eel with sweet sauce, avocado, and cucumber.',
              ),
              SushiItem(
